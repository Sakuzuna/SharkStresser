...
def main():
    ...
    proxies_path = os.path.join(script_dir, "data", "proxies.txt")
    uas_path = os.path.join(script_dir, "data", "uas.txt")

    print(f"Loading proxies from: {proxies_path}")
    print(f"Loading user agents from: {uas_path}")

    proxies = load_proxies(proxies_path)
    user_agents = load_user_agents(uas_path)

    print(f"Loaded {len(proxies)} proxies and {len(user_agents)} user agents.")
